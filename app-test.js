...
describe('Planets API Suite', () => {
    describe('Fetching Planet Details', () => {
        it('it should fetch a planet named Mercury', (done) => {
            let payload = { id: 1 }
            chai.request(server).post('/planet').send(payload).end((err, res) => {
...
describe('Testing Other Endpoints', () => {
    ...
    describe('it should fetch Home Page', () => {
        it('it checks Home endpoint', (done) => {
    ...
    describe('it should handle planet not found', () => {
        it('it returns planet not found for invalid id', (done) => {
            let payload = { id: 99 }
            chai.request(server).post('/planet').send(payload).end((err, res) => {
                res.should.have.status(200);
                res.text.should.eql('Planet not found');
                done();
            });
        });
    });
